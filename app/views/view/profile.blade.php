            ...
            <aside class="col-lg-3">
                <div class="card border-dark rounded-0 shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <h5 class="fw-bold">{{ $user_info['ten'] }}</h5>
                ...
                <div class="card border-dark rounded-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        <form action="/profile/update" method="POST" enctype="multipart/form-data">
                            <input type="hidden" name="old_avatar" value="{{ $user_info['avatar'] ?? 'default-avatar.png' }}">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control rounded-0 border-secondary bg-light" value="{{ $user_info['email'] }}" readonly>
                                    </div>
                                </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        @else
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="p-3 border {{ $addr['is_default'] ? 'border-dark bg-light' : 'border-secondary' }}">
                                        <div class="d-flex justify-content-between">
                                            <h6 class="fw-bold mb-1">{{ $addr['ten_nguoi_nhan'] }} | {{ $addr['sdt'] }}</h6>
                                            @if($addr['is_default']) <span class="badge bg-dark rounded-0">Mặc định</span> @endif
                                        </div>
                                        <p class="mb-0 text-muted">{{ $addr['dia_chi'] }}</p>
                                    </div>
                                </div>
                                @endforeach
                            </div>
