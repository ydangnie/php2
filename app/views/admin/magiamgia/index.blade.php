        ...
        <div class="container py-4">
            ...
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-body">
                    ...
                    {{-- Hiển thị thông báo nếu có (Sử dụng session PHP thuần nếu bạn không dùng helper) --}}
                    ...
                    {{-- Form tìm kiếm (Gửi về Controller index) --}}
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    {{-- Duyệt mảng $ds_ma từ Controller truyền sang --}}
                    ...
                    {{-- Phần phân trang đã được ẩn vì Controller hiện tại load tất cả (fetchAll) --}}
                    {{-- Nếu sau này bạn code thêm phân trang trong Controller thì mở lại --}}
