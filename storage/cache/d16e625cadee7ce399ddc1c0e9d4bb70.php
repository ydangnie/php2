...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1 d-flex align-items-center justify-content-center py-5">
        <div class="auth-container shadow-sm">
            ...
            <form action="/auth/nhapmk" method="POST">
                <div class="mb-3">
                    <label for="password" class="form-label small fw-bold text-uppercase">Nhập mật khẩu mới</label>
                    <input type="password" class="form-control" id="password" name="matkhaumoi" placeholder="Mật khẩu mới" required>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\all_php\php11\app\views/auth/nhapmk.blade.php ENDPATH**/ ?>