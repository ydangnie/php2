            ...
            <div class="col-md-3">
                <div class="stat-card p-3 d-flex align-items-center justify-content-between border-start border-5 border-primary">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e($countProducts ?? 0); ?></h2>
                    </div>
            ...
            <div class="col-md-3">
                <div class="stat-card p-3 d-flex align-items-center justify-content-between border-start border-5 border-warning">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e($countOrders ?? 0); ?></h2>
                    </div>
            ...
            <div class="col-md-3">
                <div class="stat-card p-3 d-flex align-items-center justify-content-between border-start border-5 border-info">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e($countUsers ?? 0); ?></h2>
                    </div>
...
</html><?php /**PATH C:\xampp\htdocs\all_php\php11\app\views/admin/dashboard.blade.php ENDPATH**/ ?>