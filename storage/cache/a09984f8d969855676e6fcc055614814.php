                ...
                <form action="/danhmuc/luu" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="tendanhmuc" required placeholder="Nhập tên danh mục...">
                        </div>
                        ...
                        <div class="col-12 mt-4 pt-3 border-top d-flex justify-content-end gap-3">
                            <a href="/danhmuc/index" class="btn btn-outline-cancel">Hủy bỏ</a>
...
</html><?php /**PATH C:\xampp\htdocs\all_php\php11\app\views/admin/danhmuc/them.blade.php ENDPATH**/ ?>