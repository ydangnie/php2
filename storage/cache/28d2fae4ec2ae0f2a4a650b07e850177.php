    ...
    <main class="flex-grow-1 py-5">
        <div class="container">
            <div class="admin-container">
                ...
                <form action="/danhmuc/update/<?= $danhmuc['id'] ?>" method="POST" enctype="multipart/form-data">
                    
                    <div class="row g-4">
                        <div class="col-12">
                            <label class="form-label">Tên Danh Mục</label>
                            <input type="text" class="form-control" name="tendanhmuc" value="<?= $danhmuc['tendanhmuc'] ?>" required placeholder="Nhập tên danh mục...">
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex align-items-start gap-4 p-3 bg-light border">
                                <div class="text-center">
                                    ...
                                    <?php if(!empty($danhmuc['img'])): ?>
                                        <img src="/uploads/<?= $danhmuc['img'] ?>" alt="Current Image" class="current-img">
                                    <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\all_php\php11\app\views/admin/danhmuc/edit.blade.php ENDPATH**/ ?>