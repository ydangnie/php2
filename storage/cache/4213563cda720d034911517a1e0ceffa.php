        ...
        <div class="container">
            <div class="admin-container">
                ...
                <div class="page-header">
                    <h3 class="fw-bold text-uppercase m-0">Sửa Sản Phẩm</h3>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="danhmuc_id" required>
                                ...
                                <?php foreach ($danhmuc as $dm): ?>
                                    <option value="<?= $dm['id'] ?>" <?= ($dm['id'] == $product['danhmuc_id']) ? 'selected' : '' ?>>
                                        <?= $dm['tendanhmuc'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="thuonghieu_id" required>
                                ...
                                <?php foreach ($thuonghieu as $th): ?>
                                    <option value="<?= $th['id'] ?>" <?= ($th['id'] == $product['thuonghieu_id']) ? 'selected' : '' ?>>
                                        <?= $th['tenthuonghieu'] ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
...
</html><?php /**PATH C:\xampp\htdocs\all_php\php11\app\views/admin/products/edit.blade.php ENDPATH**/ ?>