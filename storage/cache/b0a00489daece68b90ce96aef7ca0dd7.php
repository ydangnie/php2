...
<head>
    ...
    <title>Xác nhận OTP - MyShop</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="flex-grow-1 d-flex align-items-center justify-content-center py-5">
        <div class="auth-container shadow-sm">
            ...
            <form action="/auth/xacnhan" method="POST">
                <div class="mb-3">
                    <label for="otp" class="form-label small fw-bold text-uppercase">Mã OTP</label>
...
</html><?php /**PATH C:\xampp\htdocs\all_php\php11\app\views/auth/xacnhan.blade.php ENDPATH**/ ?>